...
public class createArray {
    public static void main(String[] args) throws NoSuchFieldException {
        ...
        System.out.println(list1.getClass().getName());               // The getClass().getName() method returns the fully qualified class name of the object.
        list1.add("e");                                             //Exception in thread "main" java.lang.UnsupportedOperationException
    }
} 